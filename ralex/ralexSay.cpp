...
bool move(unsigned int uiPos1,unsigned int uiPos2,unsigned int uiPos3, unsigned char opTime)
{
    SendIJogPacket stSendIJOGPacket;
    ...
    stSendIJOGPacket.ucData[4] = opTime;
    ...
    stSendIJOGPacket.ucData[9] = opTime;
    ...
    stSendIJOGPacket.ucData[14] = opTime;
...
int main(void)
{
    ...
    printf("Ready to Move and Say\n");

    move(424,600,400,50); sleep(1);
    move(544,480,500,50); sleep(1);
    move(424,600,400,50); sleep(1);
    snprintf(tts, 128, "%s\"%s\"", cmd, "Hello");
    system(tts);
    system(say);
    move(424,600,500,50); sleep(1);
    move(424,600,400,50); sleep(1);
    snprintf(tts, 128, "%s\"%s\"", cmd, "My friend.");
    system(tts);
    system(say);
    move(424,600,500,50); sleep(1);
    move(424,600,400,50); sleep(1);
